        ...
        <div class="row">
            ...
            <div class="col-md-6 col-lg-3">
                <div class="block-5 mb-5">
                    ...
                    <ul class="list-unstyled">
                        <li class="address">NO.4/1417,5th street,A.V Nagar,Madhanandapuram,Chennai</li>
                        <li class="phone"><a href="tel://9566000581">+91 9566000581</a></li>
                        <li class="email">support@shoppers.com</li>
                    </ul>
                </div>
