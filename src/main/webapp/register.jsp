...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/static/fonts/Linearicons-Free-v1.0.0/icon-font.min.css">
                ...
                <form action="register" method="post"
                    ...
                    <div class="wrap-input100 validate-input m-b-16" data-validate="Password is required">
                      ...
                      <div class="wrap-input100 validate-input m-b-16" data-validate="Role is required">
                        <select class="input100"  name="role" required  style="border:none; opacity:50% ;">
